...
The adversarial framework above is agnostic to how $z$ is produced. Our primary experiments use the scCRAFT VAE as the reference backbone; to test whether our findings depend on this choice, we additionally evaluate three alternative backbones that share the same encoder/decoder interface but differ in their generative assumptions, described per architecture below.

\subsubsection{Reference backbone: scCRAFT}
